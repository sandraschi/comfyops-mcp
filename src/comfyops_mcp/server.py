...
def _run_http(port: int):
    ...
    app = Starlette(
        routes=[
            ...
            Route("/api/gallery", endpoint=_rest.api_gallery_list),
            Route("/api/gallery/delete", endpoint=_rest.api_gallery_delete, methods=["POST"]),
            Route("/api/gallery/export", endpoint=_rest.api_gallery_export),
            Route("/api/gallery/{prompt_id}/related", endpoint=_rest.api_gallery_related),
